        ...
        <div className="bg-surface/50 border border-white/5 rounded-xl p-6 backdrop-blur-sm">
          <div className="flex items-start justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-semibold text-white">WakaTime</h2>
                <p className="text-sm text-slate-400">Coding activity tracking</p>
              </div>
            </div>
            <div className={cn(
        ...
        <div className="bg-surface/50 border border-white/5 rounded-xl p-6 backdrop-blur-sm">
          <div className="flex items-start justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-semibold text-white">Google Fit</h2>
                <p className="text-sm text-slate-400">Physical activity & health</p>
              </div>
            </div>
            <div className={cn(
              "px-3 py-1 rounded-full text-sm font-medium flex items-center gap-2 border",
          ...
          <div className="flex items-start justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-400">Meetings & events</p>
              </div>
            </div>
            <div className={cn(
              "px-3 py-1 rounded-full text-sm font-medium flex items-center gap-2 border",
